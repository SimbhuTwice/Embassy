...
@section('content')
    <div class="cctv-sect pl-3">
        <div class="row">
            @foreach($googlemapList as $gmap)
            <div class="col-sm-12 pr-2">
                <div class="box">
                    <div class="box-head">
                        <div class="row">
                            <div class="col-sm-12 head-title">
                                <h5>{{ explode(';', $gmap->value)[0] }}</h5>
                            </div>
                        </div>
                    </div>
                    <div class="box-body">
                        <iframe src="{{ explode(';', $gmap->value)[1] }}" title="googemaps" allowfullscreen="" loading="lazy"></iframe>
                    </div>
                </div>
            </div>
            @endforeach
