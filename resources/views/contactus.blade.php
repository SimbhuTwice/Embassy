            ...
            <div class="col-sm-6">
                <form>
                    <div class="contact-right">
                        <div class="head-sect">
                            <h1>24x7 We Are Ready</h1>
                        </div>
                        <div class="text-area">
                            <p>Do you have any queries?</p>
                            <div class="form-group blue-border-focus shadow-textarea">
                                <textarea class="form-control z-depth-1" id="exampleFormControlTextarea6" rows="3" placeholder="Maximum 600 words" style="resize: none;"></textarea>
                            </div>
                        </div>
                        <div class="sub-btn"><button type="submit" class="btn">Submit</button></div>
                    </div>
                </form>
            </div>
        </div>
...
@section('script')
    <script>
        ...
        var red = '#c23927', green = '#00a652', white = '#ffffff';
